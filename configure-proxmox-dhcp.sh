...
# Display banner
echo -e "\n${GREEN}=============================================================${NC}"
echo -e "${GREEN}        Proxmox DHCP Configuration Script (Enhanced)         ${NC}"
echo -e "${GREEN}=============================================================${NC}"
echo
...
# Improved function to verify if an interface is a physical interface
is_physical_interface() {
    ...
    # Enhanced interface validation regex - only accept common interface naming patterns
    if ! echo "$iface" | grep -qE '^(en|eth|ens|enp|wl)[a-zA-Z0-9]*
...
# Improved function to get network link status
get_link_status() {
    local iface="$1"
